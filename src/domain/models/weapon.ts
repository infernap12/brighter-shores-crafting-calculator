...
export class Weapon implements Item {
	constructor(imageUrl: string, fullName: string, recipe: Recipe, levelMax: number, public faction: Faction, public description: string, public variant: string, public name: string) {
